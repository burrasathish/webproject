    ...
    <div id="container">
        <nav class="navbar">
            ...
            <div class="navbar-links">
                <ul>
                    ...
                    <li><a href="#">View Plains</a></li>
                </ul>
            </div>
            <div>
              <a href="Signup.jsp"><b>Signup</b></a> |
              <a href="Signin.jsp"><b>Signin</b></a>
            </di>
        </nav>
        ...
        <section id="section-items">
            <div class="section-text">
                <hr class="section-hr">
                <p class="section-large">Humanizing</br>your insurance.</p>
                <p class="section-small">Get your life insurance coverage easier and faster. We blend our expertise
                    and technology to help you find the plan that’s right for you. Ensure you
                    and your loved ones are protected.</p>
                <button class="button button1">View Plains</button>
            </div>
        ...
        <div class="row">
            <div class="column" id="snappy">
                <img src="./Images/icon-snappy-process.svg">
                <p><b>Snappy Process</b></p>
                <p>Our application process can be completed in minutes, not hours. Don’t get stuck filling in tedious
                    forms.
                </p>
            </div>

            <div class="column" id="affor">
                <img src="./Images/icon-affordable-prices.svg">
                <p><b>Afforable Prices</b></p>
                <p> We don’t want you worrying about high monthly costs. Our prices may be low, but we still offer the
                    best
                    coverage possible.</p>
            </div>
            ...
            <div class="column" id="people">
                ...
                <p>First Our plans aren’t full of conditions and clauses to prevent payouts. We make sure you’re covered
                    when you need it.</p>
            </div>
        </div>
        ...
        <div class="how">
            <h1 class="kk">Find Out more about how we work</h1>
            <!-- <img src="./images/bg-pattern-how-we-work-desktop.svg" class="out"> -->
            <button class="button" type="button">VIEW PLANS</button>
        </div>


        <footer>
            <!-- <img id="images" src="./images/bg-pattern-footer-desktop.svg"> -->
            <img id="mobile_image" src="./Images/bg-pattern-footer-mobile.svg">
            <div id="total_links">
                <img id="insure_logo" src="./Images/logo.svg">
                <div id="links">
                    <a href="#"><svg class="display_view" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            fill="#837D88">
                    ...
                    <a href="#"><svg class="display_view" xmlns="http://www.w3.org/2000/svg" width="24" height="20"
                            fill="#837D88">
            ...
            <div id="footer_content">
                <div class="footer_same">
                    <label>OUR COMPANY</label>
                    <a class="footer_down" href="#">HOW WE WORK</a>
                    <a class="footer_down" href="#">WHY INSURE?</a>
                    <a class="footer_down" href="#">VIEW PLANS</a>
                    <a class="footer_down" href="#">REVIEWS</a>
                </div>
                <div class="footer_same">
                    <label>HELP ME</label>
                    <a class="footer_down" href="#">FAQ</a>
                    <a class="footer_down" href="#">PRIVACY POLICY</a>
                    <a class="footer_down" href="#">TERMS OF USE</a>
                    <a class="footer_down" href="#">COOKIES</a>
                    </ul>
                </div>
                <div class="footer_same">
                    <label>CONTACTS</label>
                    <a class="footer_down" href="Contact.jsp">ContactUs</a>
                    <a class="footer_down" href="#">SALES</a>
                    <a class="footer_down" href="#">SUPPORT</a>
                    <a class="footer_down" href="#">LIVE CHAT</a>
                </div>
                <div class="footer_same">
                    <label>OTHERS</label>
                    <a class="footer_down" href="#">CAREERS</a>
                    <a class="footer_down" href="#">PRESS</a>
                    <a class="footer_down" href="#">LICIENSE</a>
                </div>
            </div>
        </footer>
    </div>
